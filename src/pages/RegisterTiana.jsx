...
const RegisterTiana = () => {
  ...
  return (
    <div>
      <div className="reg">
        <Container
          className="bg-muted text-white p-5 mt-5"
        ...
        >
          ...
          <Avatar image={profilePicture} alt={'profile picture'}/>
          <h1>Registration</h1>
      ...
      <div className="container">
        <Contact name={'Christiana'} email={'Christiana@gmail.com'} phoneNumber={12223} linkedIn={"linkedIn.com"} buttonName={'connect'} image={profilePicture}/>
      </div>
    </div>
  );
};
